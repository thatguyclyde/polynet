        ...
        <div style={{ padding: '16px 20px', background: '#ffffff', borderBottom: '1px solid #F1F1F5' }}>
          ...
          <textarea
            ...
            style={{
              width: '100%', padding: '12px', borderRadius: '12px',
              border: '1.5px solid #F1F1F5', background: '#FAFAFA',
              fontSize: '14px', color: '#1A1A2E', resize: 'none', outline: 'none',
        ...
        {filtered.map(l => (
          ...
          >
            {l.image_url ? (
              ...
              <div style={{ width: '100%', height: '120px', background: '#F5F3FF', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '32px' }}>
                {CATEGORIES.find(c => c.id === l.category)?.emoji || '📦'}
              </div>
            )}
